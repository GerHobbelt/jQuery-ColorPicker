...
c(document).bind("mouseup",a,r);c(document).bind("mousemove",a,s)},s=function(a){a.data.field.val(Math.max(0,Math.min(a.data.max,parseInt(a.data.val+a.pageY-a.data.y,10))));a.data.preview&&f.apply(a.data.field.get(0),[!0]);return!1},r=function(a){f.apply(a.data.field.get(0),[!0]);a.data.el.removeClass("colorpicker_slider").find("input").focus();c(document).unbind("mouseup",r);c(document).unbind("mousemove",s);return!1},B=function(){var a={cal:c(this).parent(),y:c(this).offset().top};a.preview=a.cal.data("colorpicker").livePreview;
c(document).bind("mouseup",a,t);c(document).bind("mousemove",a,u)},u=function(a){f.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,a.pageY-a.data.y)))/150,10)).get(0),[a.data.preview]);return!1},t=function(a){h(a.data.cal.data("colorpicker").color,a.data.cal.get(0));j(a.data.cal.data("colorpicker").color,a.data.cal.get(0));c(document).unbind("mouseup",t);c(document).unbind("mousemove",u);return!1},C=function(a){y=c(this).offset().top;preview=a.data.cal.data("colorpicker").livePreview;
f.apply(a.data.cal.data("colorpicker").fields.eq(4).val(parseInt(360*(150-Math.max(0,Math.min(150,a.pageY-y)))/150,10)).get(0),[preview])};downSelector=function(){var a={cal:c(this).parent(),pos:c(this).offset()};a.preview=a.cal.data("colorpicker").livePreview;c(document).bind("mouseup",a,upSelector);c(document).bind("mousemove",a,moveSelector);c(".colorpicker_color").one("click",a,moveSelector)};moveSelector=function(a){f.apply(a.data.cal.data("colorpicker").fields.eq(6).val(parseInt(100*(150-Math.max(0,
Math.min(150,a.pageY-a.data.pos.top)))/150,10)).end().eq(5).val(parseInt(100*Math.max(0,Math.min(150,a.pageX-a.data.pos.left))/150,10)).get(0),[a.data.preview]);return!1};upSelector=function(a){c(this).parent();c(this).offset();h(a.data.cal.data("colorpicker").color,a.data.cal.get(0));j(a.data.cal.data("colorpicker").color,a.data.cal.get(0));c(document).unbind("mouseup",upSelector);c(document).unbind("mousemove",moveSelector);return!1};enterSubmit=function(){c(this).addClass("colorpicker_focus")};
...
e.h&&(d-=this.offsetHeight+176);b+356>e.l+e.w&&(b-=356);a.css({left:b+"px",top:d+"px"});!1!=a.data("colorpicker").onShow.apply(this,[a.get(0)])&&a.show();c(document).bind("mousedown",{cal:a},hide);return!1};hide=function(a){isChildOf(a.data.cal.get(0),a.target,a.data.cal.get(0))||(!1!=a.data.cal.data("colorpicker").onHide.apply(this,[a.data.cal.get(0)])&&a.data.cal.hide(),c(document).unbind("mousedown",hide))};isChildOf=function(a,b,c){if(a==b)return!0;if(a.contains)return a.contains(b);if(a.compareDocumentPosition)return!!(a.compareDocumentPosition(b)&
...
RGBToHSB=function(a){var b={h:0,s:0,b:0},c=Math.min(a.r,a.g,a.b),d=Math.max(a.r,a.g,a.b),c=d-c;b.b=d;b.s=0!=d?255*c/d:0;b.h=0!=b.s?a.r==d?(a.g-a.b)/c:a.g==d?2+(a.b-a.r)/c:4+(a.r-a.g)/c:-1;b.h*=60;0>b.h&&(b.h+=360);b.s*=100/255;b.b*=100/255;return b};HSBToRGB=function(a){var b,c,d;b=Math.round(a.h);var g=Math.round(255*a.s/100);a=Math.round(255*a.b/100);if(0==g)b=c=d=a;else{var g=(255-g)*a/255,f=(a-g)*(b%60)/60;360==b&&(b=0);60>b?(b=a,d=g,c=g+f):120>b?(c=a,d=g,b=a-f):180>b?(c=a,b=g,d=g+f):240>b?(d=
a,b=g,c=a-f):300>b?(d=a,c=g,b=g+f):360>b?(b=a,c=g,d=a-f):d=c=b=0}return{r:Math.round(b),g:Math.round(c),b:Math.round(d)}};RGBToHex=function(a){var b=[a.r.toString(16),a.g.toString(16),a.b.toString(16)];c.each(b,function(a,c){1==c.length&&(b[a]="0"+c)});return b.join("")};RGBstringToHex=function(a){function b(a){return("0"+parseInt(a).toString(16)).slice(-2)}if(!a)return"#FFFFFF";var c=a.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);return c?"#"+b(c[1])+b(c[2])+b(c[3]):a};HSBToHex=function(a){return RGBToHex(HSBToRGB(a))};
...
a.color.s&&void 0!=a.color.b)a.color=fixHSB(a.color);else return this;return this.each(function(){if(!c(this).data("colorpickerId")){var b=c.extend({},a);b.origColor=a.color;for(var e=!1,d=0,e=0==c("#colorpicker_"+d).length;!e;)d=parseInt(1E4*Math.random()),e=0==c("#colorpicker_"+d).length;e="colorpicker_"+d;c(this).data("colorpickerId",e);b.parent=c(this);d=c('<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>');
d.attr("id",e).attr("data-parent",c(this).attr("id"));b.flat?d.appendTo(this).show():d.appendTo(document.body);b.fields=d.find("input").bind("keyup",w).bind("change",f).bind("blur",x).bind("focus",z);d.find("span").bind("mousedown",A).end().find(">div.colorpicker_current_color").bind("click",restoreOriginal);b.selector=d.find("div.colorpicker_color").bind("mousedown",downSelector);b.selectorIndic=b.selector.find("div div");b.el=this;b.hue=d.find("div.colorpicker_hue div");d.find("div.colorpicker_hue").bind("mousedown",
B);d.find("div.colorpicker_hue").bind("click",{cal:d},C);b.newColor=d.find("div.colorpicker_new_color");b.currentColor=d.find("div.colorpicker_current_color");d.data("colorpicker",b);d.find("div.colorpicker_submit").bind("mouseenter",enterSubmit).bind("mouseleave",leaveSubmit).bind("click",clickSubmit);h(b.color,d.get(0));k(b.color,d.get(0));j(b.color,d.get(0));m(b.color,d.get(0));l(b.color,d.get(0));p(b.color,d.get(0));n(b.color,d.get(0));b.flat?d.css({position:"relative",display:"block"}):c(this).bind(b.eventName,
